...
#### Overview
- The proxy server will be implemented as part of the MCP server process.
...
6. Add a new tab in the MCP web page to display proxy logs (requests/responses, FIFO, no persistent memory).
